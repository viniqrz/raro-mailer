...
export class init1637647556751 implements MigrationInterface {
    name = 'init1637647556751'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`action\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(120) NOT NULL, \`subject\` varchar(80) NOT NULL, \`body\` varchar(1200) NOT NULL, \`date\` datetime NOT NULL, \`active\` tinyint NOT NULL DEFAULT 1, \`actorId\` int NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
